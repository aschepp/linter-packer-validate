  ...
  provideLinter() {
    return {
      ...
      lint: (activeEditor) => {
        ...
        const directory = activeEditor.getDirectoryPath();
        ...
        return helpers.exec(atom.config.get('linter-packer-validate.packerExecutablePath'), args, {ignoreExitCode: true, cwd: directory}).then(output => {
          var toReturn = [];
          var error = ''
